    ...
    <div className={`flex flex-col gap-3 ${className}`}>
      <div>
        <Image
          ...
          width={0}
          height={0}
          className="size-[40px] xs:size-[50px] dark:invert"
        />
      </div>
      <div className={`flex flex-col gap-3 max-w-[230px] ${itemsClass}`}>
        <h4 className="text-text text-sm xs:text-base">{title}</h4>
        <p className="text-xs xs:text-sm text-muted !leading-[1.8]">{desc}</p>
      </div>
    </div>
  );
};
...
const Page = () => {
  return (
    <section className="py-20 l-container">
      ...
      <section className="py-20 dark:bg-none dark:bg-foreground bg-[url('/assets/aboutbg.webp')] bg-no-repeat bg-cover rounded-lg mt-8 px-2 xs:px-5 sm:px-20">
        <div className="grid md:grid-cols-2 gap-4 place-items-center">
          <div className="flex flex-col gap-4">
            <h3 className="text-2xl xs:text-3xl text-text font-semibold max-w-[230px] !leading-[1.4]">
              We Make World Travel Easy
            </h3>
            <p className="text-xs xs:text-sm text-muted !leading-[1.8] max-w-[370px]">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="flex sm:flex-col gap-4">
              <Card
                ...
                className="bg-card items-center p-[20px] xs:p-[40px] rounded-lg"
            ...
            <div className="self-center mx-auto sm:mx-0">
              <Card
                ...
                title="3672"
                desc="Amazing Tours"
                className="bg-card items-center p-[20px] xs:p-[40px] rounded-lg max-w-max sm:max-w-auto"
                itemsClass="items-center max-w-auto !gap-1 [&_>_h4]:text-primary"
              />
            </div>
          </div>
